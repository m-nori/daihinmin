...
* <a href="#websocket">WebScoketのデータ仕様</a>
  ...
  * <a href="#websocket-2">各オペレーションのJSON</a>
      1. <a href="#websocket-2-1">start_place</a>
      2. <a href="#websocket-2-2">start_game</a>
      3. <a href="#websocket-2-3">start_turn</a>
      4. <a href="#websocket-2-4">end_player</a>
      5. <a href="#websocket-2-5">end_turn</a>
      6. <a href="#websocket-2-6">end_game</a>
      7. <a href="#websocket-2-7">end_place</a>
* <a href="#api">プレイヤー用APIの仕様</a>
  * <a href="#api-1">ログイン</a>
      1. <a href="#api-1-1">http://#{サーバ}/login</a>
  * <a href="#api-2">情報取得</a>
      1. <a href="#api-2-1">http://#{サーバ}/get_hand.(json or xml)</a>
      2. <a href="#api-2-2">http://#{サーバ}/get_place_info.(json or xml)</a>
  * <a href="#api-2">情報送信</a>
      1. <a href="#api-2-1">http://#{サーバ}/post_cards</a>
